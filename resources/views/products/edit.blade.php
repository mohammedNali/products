    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center pt-5">
                ...
                <form id="edit-frm" method="POST" action="{{ route('products.update', $product) }}" class="border p-3 mt-2">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="control-group col-6 mt-2 text-left">
						...
						<textarea id="description" class="form-control mb-4" name="description"
                                  placeholder="Enter Description" rows="" required>{!! $product->description !!}</textarea>
                        </div>
                    </div>
